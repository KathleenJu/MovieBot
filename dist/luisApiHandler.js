...
function luisAPICall(luisRequestURI) {
    return __awaiter(this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, node_fetch_1.default(luisRequestURI)];
                case 1:
                    response = _a.sent();
...
exports.luisAPICall = luisAPICall;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, luisAPICall(luisRequestURI)];
